...
internal class EngineerImplementation : IEngineer
{
    ...
    public BO.Engineer? Read(int id)
    {
        ...
        DO.Task? task = _dal.Task.ReadAll().FirstOrDefault(task => task?.EngineerId == id && TaskImplementation.CalculateStatus(task.StartDate, task.ScheduledDate, task.DeadlineDate, task.CompleteDate) == BO.Status.OnTrack);
